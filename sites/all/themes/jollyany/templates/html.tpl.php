...
<body <?php if(count($getPageStyle2) > 0 || $_GET['layout'] == 'boxed' || theme_get_setting('layout_option') == 'boxed') { echo 'id="boxed"'; } ?> class="<?php print $classes; ?> <?php print theme_get_setting('color_scheme'); ?>" <?php print $attributes;?>>
	...
	<div class="dmtopd">Scroll to Bottom</div><div class="dmtop">Scroll to Top</div>
	<!-- Main Scripts-->
	...
	<script type="text/javascript">
        ...
        <script type="text/javascript">
		jQuery(window).load(function(){
		  jQuery('.tit-submenu-personas  a:first-child').attr("href","#").click(function(){return false;});
                   jQuery('.tit-submenu-empresas  a:first-child').attr("href","#").click(function(){return false;});
                    jQuery('.tit-submenu-servicios  a:first-child').attr("href","#").click(function(){return false;});
		});
	</script>

	<!-- Google Map -->
	<script type="text/javascript">
		var locations = <?php echo theme_get_setting('contactmap_address'); ?>;
		...
		var map = new google.maps.Map(document.getElementById('map'), {
		  zoom: 8,
			...
			styles: [ { "stylers": [ { "hue": "#000" },  {saturation: -100},
                {gamma: 0.50} ] } ],
			center: new google.maps.LatLng(10.416140, -67.501157),

...
<footer id="footer-style-1">
	<div class="container">
		...
		<?php else :?>
			<?php 
			$cant = ((int)!empty($page['footer_1'])+(int)!empty($page['footer_2'])+(int)!empty($page['footer_3'])+(int)!empty($page['footer_4']));
			$numColn = 12/($cant>0?$cant:1);
			?>
            <?php if ($page['footer_1']) : ?>
            <div class="col-lg-<?php echo $numColn;?> col-md-<?php echo $numColn;?> col-sm-6 col-xs-12">				
					<?php print render($page['footer_1']); ?>				
			</div><?php endif; ?>
			<?php if ($page['footer_2']) : ?>
            <div class="col-lg-<?php echo $numColn;?> col-md-<?php echo $numColn;?> col-sm-6 col-xs-12">				
